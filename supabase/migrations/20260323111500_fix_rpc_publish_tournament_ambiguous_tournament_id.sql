-- Fix ambiguous reference in rpc_publish_tournament
-- Some environments still had a version using:
--   WHERE tournament_id = tournament_id
-- which causes: column reference "tournament_id" is ambiguous
...
BEGIN
  ...
  -- IMPORTANT: use local variable name to avoid ambiguous reference.
