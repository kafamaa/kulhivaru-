-- Fix: rpc_publish_tournament inserted NULL visibility for "public"
-- Previous mapping used NULLIF(category_record->>'visibility', 'public'),
-- which turns "public" into NULL and violates NOT NULL on tournament_categories.visibility.
