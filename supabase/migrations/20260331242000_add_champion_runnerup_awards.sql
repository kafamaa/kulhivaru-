-- Add champion/runner-up trophy award keys for manual tournament awards.
...
DROP CONSTRAINT IF EXISTS tournament_awards_award_key_check;

ALTER TABLE public.tournament_awards
ADD CONSTRAINT tournament_awards_award_key_check
CHECK (
  award_key IN (
    'mvp',
    'best_goalkeeper',
